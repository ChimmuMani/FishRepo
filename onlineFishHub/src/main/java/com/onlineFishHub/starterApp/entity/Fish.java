...
public class Fish {
	...
	public Fish(Long id, String sku, String name, String description, BigDecimal unitPrice, String imageUrl,
			boolean active, int unitsInStock, Date createdOn, Date updatedOn, FishCategory category) {
		super();
		this.id = id;
		this.sku = sku;
		this.name = name;
